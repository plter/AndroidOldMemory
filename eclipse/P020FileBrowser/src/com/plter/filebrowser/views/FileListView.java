...
public class FileListView extends FrameLayout {
	...
	public FileListView(Context context,IViewController viewController,String dirPath) {
		super(context);
	...
	private final AdapterView.OnItemClickListener gvHeaderItemClickListener=new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			case HeaderActions.ACTION_SETTINGS:
				if (settingsVC==null) {
					settingsVC=new SettingsVC(getContext());
				}
				getViewController().pushViewController(settingsVC, true);
				break;
			default:
				break;
			}
	...
	private SettingsVC settingsVC=null;
...
//		tvCurrentDir.setText(currentDirPath);
	...
	private void changeDirTo(final File dir,int animStyle){
		FileListView view = new FileListView(getContext(), null, dir.getAbsolutePath());
